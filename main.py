...
def download():
    ...
    try:
        ...
        video.download("/home/james/Videos/YouTube")
...
Label(master, text="Please enter a YouTube link below: ", font=("Calibri", 12)).grid(sticky=N, row=1, pady=15)
notif = Label(master, font=("calibri", 12))
notif.grid(sticky=N, pady=1, row=4)
#Vars
url = StringVar()
#Entry
Entry(master, width=50, textvariable=url).grid(stick=N, row=2)
#Button
